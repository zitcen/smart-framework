...
//        }
    ...
    **/
    public static <T> boolean updateEntity(Class<T> entity,long id, Map<String,Object> fieldMap){
        ...
        StringBuilder sql = new StringBuilder("UPDATE ").append(getTableName(entity));
        sql.append(" set ");
        for (String fieldName : fieldMap.keySet()) {
     ...
     *
    **/
    public static <T> boolean delEntity(long id,Class<T> entity){

        StringBuilder sql = new StringBuilder("DELETE FROM ").
                append(getTableName(entity)).append(" where id =?;");
    ...
    public static void  beginTransaction(){
        ...
        if (!Objects.isNull(conn)) {
            try {
                ...
                LOGGER.error("begin transaction is failure ",e);
                throw new RuntimeException(e);
            } finally {
                CONNECTION_HOLDER.set(conn);
            }
    ...
    public static void  commitTransaction(){
        ...
        if (!Objects.isNull(conn)) {
            try {
                ...
                LOGGER.error("commit transaction is failure ",e);
                throw new RuntimeException(e);
            } finally {
                CONNECTION_HOLDER.set(conn);
            }
    ...
    public static void  rollbackTransaction(){
        ...
        if (!Objects.isNull(conn)) {
            try {
                ...
                LOGGER.error("rollback transaction is failure ",e);
                throw new RuntimeException(e);
            } finally {
                CONNECTION_HOLDER.remove();
            }
